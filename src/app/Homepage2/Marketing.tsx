...
export default function Marketing() {
    return (
        <>
            <div className=" w-full flex flex-wrap px-[70px] md:flex-nowrap">
                ...
                <div className="lg:w-1/2 mx-auto  mt-[20px] md:mt-[100px]">
                    <p className="text-[#414141] text-[14px] max-w-[584px] font-normal leading-[33px] ">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
