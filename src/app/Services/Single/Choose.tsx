        ...
        <>
            <div className=" mt-10 md:mt-[107px] ">
                <div className="md:flex md:justify-between lg:px-[50px]">
                    <div className="hidden md:block"><img src={`${process.env.NEXT_PUBLIC_BASE_FOLDER}assets/image/Frame(1).png`}/></div>
                    <div className="">
                    ...
                    <div className="hidden md:block"><img src={`${process.env.NEXT_PUBLIC_BASE_FOLDER}assets/image/Polygon 1.png`}/></div>
                </div>
