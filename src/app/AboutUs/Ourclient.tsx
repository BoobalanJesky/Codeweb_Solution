            ...
            <div className="mt-[107px] ">
                <div className="md:flex md:justify-between lg:px-[50px]">
                    ...
                    <div className="">
                        ...
                        <p className="text-[14px]  text-[#414141] font-normal leading-normal text-center max-w-[537px] mx-auto">Lorem Ipsum is simply dummy text of the printing and typesetting industry.Lorem Ipsum has been the industry&#39s standard dummy text ever since the 1500s</p>
                    </div>
