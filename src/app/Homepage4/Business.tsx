...
export default function Business() {
    return (
        <>
            <div className="mt-[145px] grid grid-cols-1 lg:grid-cols-2 bg-[#1E1E1E]">
                <div className="my-auto px-[20px] lg:pl-[104px] pt-[20px] md:block">
                    ...
                    <p className="font-bold text-[#FFF] pt-5 text-[28px] md:text-[30px] lg:text-[33px] md:max-w-[530px] leading-normal">Do You Want To Know More About Our Business?</p>
